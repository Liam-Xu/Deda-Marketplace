<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/water-drop.png" alt=""> <span>Deda Marketplace</span></div>
			<hr>
			...
			<a-menu theme="light" mode="inline">
				...
				<a-menu-item>
					<router-link to="/tables">
						...
						<span class="label">Browse Data</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/billing">
						...
						<span class="label">Latest Data Trading</span>
					</router-link>
				</a-menu-item>
